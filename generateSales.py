...
reader = csv.reader(open('Sales_DataDictionary_Table.csv'))

# Create the HTML file
# f_html = open(sys.argv[2],"w");
f_html = open('Sales.html',"w")

f_html.write('<title>Sales</title>')
...
f_html.write('  <a class="w3-bar-item w3-button" href="#">Sales</a>')
f_html.write('  <a class="w3-bar-item w3-button" href="#">Repair Orders</a>')
...
f_html.write('  <span id="myIntro" class="w3-hide">Customer Onboarding Form: Sales</span></p>')
f_html.write('</div>')
...
f_html.write('  <h2 class="w3-large">Sales</h2>')
f_html.write('</header>')
